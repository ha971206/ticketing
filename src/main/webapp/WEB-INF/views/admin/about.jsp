...
<div class="row tm-row tm-mb-60 tm-main">
    ...
    <div class="col-lg-6 tm-mb-60 tm-person-col">
        <div class="media tm-person">
            <img src="/ticketing/static/JWS.png" width="200" height="300" class="img-fluid" style="margin-left: 0">
        </div>
    ...
    <div class="col-lg-6 tm-mb-60 tm-person-col">
        <div class="media tm-person">
            <img src="/ticketing/static/LSG.png" width="230" height="330" class="img-fluid">
        </div>
        <div class="media-body">
    ...
    <div class="col-lg-6 tm-mb-60 tm-person-col">
        <div class="media tm-person">
            <img src="/ticketing/static/LCE.png" width="200" height="300" class="img-fluid mr-4">
        </div>
        <div class="media-body">
    ...
    <div class="col-lg-6 tm-mb-60 tm-person-col">
        <div class="media tm-person">
            <img src="/ticketing/static/HHJ.png" width="150" height="240" class="img-fluid mr-3 ml-5">
        </div>
