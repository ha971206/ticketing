...
<head>
    ...
    <style>
        body {
            background-image: url("/ticketing/static/back.jpg");
        }
...
<div class="container-fluid flex-column justify-content-center" style="height: 80vh; width: 320px; margin-top: 200px">
    ...
    <div class="card align-self-center">
        ...
        <div class="card-body">
            ...
            <%--                </div>--%>
            <%--            </c:if>--%>
            <form id="registerForm" action="/ticketing/member/login" method="post">
                ...
                <div>
                    <a href="/ticketing/oauth2/authorization/kakao" style="text-decoration: none; margin-left: 22px;">
                        <c:url value="/static/kakaoLogo.png" var="kakaoLogoLink"/>
                        <img src="${kakaoLogoLink}" alt="">
                    </a>

                    <a href="/ticketing/oauth2/authorization/google" style="text-decoration: none; margin-left: 22px;">
                        <c:url value="/static/googleLogo.png" var="googleLogoLink"/>
                        <img src="${googleLogoLink}" alt="">
                    </a>

                    <a href="/ticketing/oauth2/authorization/naver">
                ...
                <div class="my-4">
                    <div style="font-family: 'LINESeedKR-Bd'; text-align: center" class="float-first">
                        회원이 아니신가요? <a href="/ticketing/customer/signup">회원가입</a>
                    </div>
                    <br>
                    <div class="float-end">
