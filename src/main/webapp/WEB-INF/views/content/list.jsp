...
<head>
  ...
  <link rel="stylesheet" href="/ticketing/static/fontawesome/css/all.min.css"> <!-- https://fontawesome.com/ -->
      ...
      <article class="col-12 col-md-6 tm-post" style="min-width:50%;max-width:calc(100 - 50%);">
        ...
        <div class="tm-post-link-inner" style="">
          <a href="${getLink}" class="effect-lily tm-post-link tm-pt-60" style="max-height: 626px;">
              <%-- 이미지 --%>
            <img src="${imgUrl}/${content.contentId}/${content.contentPosterName}" onerror="this.src='/ticketing/static/oo.ico'" alt="Image" class="img-fluid" style="max-width:470px">
          </a>
        </div>
              <%-- 제목 --%>
